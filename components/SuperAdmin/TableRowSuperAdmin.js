  ...
  return (
    <tbody className="last:border-b-0 text-sm">
      <tr className="border-b font-section">
        <td className="text-left p-4">{props.cedula}</td>
        <td className="text-left p-4">{props.nombres}</td>
        <td className="text-left p-4">{props.apellidos}</td>
        <td className="text-left p-4">{props.correo}</td>
