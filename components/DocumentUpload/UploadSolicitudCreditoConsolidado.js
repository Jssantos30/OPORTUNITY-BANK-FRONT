    ...
    <div>
      <Formik
        ...
        validationSchema={Yup.object({
          uploadSolicitudCreditoConsolidado: Yup.string().matches(
            /SOLICITUDES DE CREDITO CONSOLIDADO Coofinep.(xlsx|xlsb)$/,
            'El archivo debe llamarse SOLICITUDES DE CREDITO CONSOLIDADO Coofinep.xlsx y el formato .xlsx ejemplo: SOLICITUDES DE CREDITO CONSOLIDADO Coofinep.xlsx ',
          ),
        })}
...
export default UploadSolicitudCreditoConsolidado
