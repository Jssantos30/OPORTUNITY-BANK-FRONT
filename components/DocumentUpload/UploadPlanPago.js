    ...
    <div className="w-full">
      <Formik
        ...
        validationSchema={Yup.object({
          planPagos: Yup.string().matches(
            /PLAN DE PAGOS.(xlsx|xlsb)$/,
            'El archivo debe llamarse PLAN DE PAGOS y formato .xlsx o .xlsb ejemplo: PLAN DE PAGOS.xlsx ',
          ),
        })}
