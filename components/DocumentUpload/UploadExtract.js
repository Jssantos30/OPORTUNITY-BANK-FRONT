    ...
    <div>
      <Formik
        ...
        validationSchema={Yup.object({
          uploadExtract: Yup.string().matches(
            /Extracto_\d{6}.(xlsx|xlsb)$/,
            'El archivo debe llamarse Extracto_año-mes y formato .xlsx o .xlsb ejemplo: Extracto_202112.xlsb',
          ),
        })}
        onSubmit={async (_, actions) => {
          try {
            ...
            const fetchDoc = await customFetch(url, {
              method: 'POST',
              body: file,
