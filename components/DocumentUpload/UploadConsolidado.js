...
const UploadConsolidados = () => {
  ...
  return (
    <div className="w-full border-b border-color_gray_8 pb-4">
      <Formik
        initialValues={{
          uploadConsolidado: '',
        }}
        validationSchema={Yup.object({
          ...
          // .matches(
          //   /209_consolidado\d{6}.(xlsx|xlsb)$/,
          //   'El archivo debe llamarse 209_consolidado.y formato .xlsx o .xlsb ejemplo: 209_consolidado.xlsx ',
          // ),
        })}
...
export default UploadConsolidados
