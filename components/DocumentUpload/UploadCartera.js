      ...
      <Formik
        ...
        validationSchema={Yup.object({
          uploadCartera: Yup.string().matches(
            /cartera_castigada_\d{6}.(xlsx|xlsb)$/,
            'El archivo debe llamarse cartera_castigada__año-mes y formato .xlsx o .xlsb ejemplo: cartera_castigada_202112.xlsx',
          ),
        })}
