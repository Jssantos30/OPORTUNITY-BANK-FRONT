    ...
    <div>
      <Formik
        ...
        validationSchema={Yup.object({
          uploadCofinet: Yup.string().matches(
            /coofinep_\d{6}.(xlsx|xlsb)$/,
            'El archivo debe llamarse coofinep_año-mes y formato .xlsx o .xlsb ejemplo: coofinep_202112.xlsx ',
          ),
        })}
