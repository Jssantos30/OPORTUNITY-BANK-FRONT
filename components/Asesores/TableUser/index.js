    ...
    <div className="table-responsive">
      <table className="mx-auto bg-white rounded-lg rounded-t-none w-full">
        <thead className="border-b font-bold text-xs">
          <tr>
            {ROLES.includes(rol) ? <td className="text-center py-4 px-2"> Check </td> : null}
            {ROLES.includes(rol) ? <td className="text-center py-4 px-2"> Asignado </td> : null}
            <th className="py-4 px-2 text-center">C.C</th>
