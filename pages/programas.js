...
const Programas = () => {
  return (
    <>
      <Banner title="Programas" image_url={`${process.env.NEXT_BASE_PATH}/programas-banner.png`} />
      <Section
        title="Red de Apoyo Financiero"
        image_url={`${process.env.NEXT_BASE_PATH}/section1-programas.png`}
        color="bg-color_gray_2"
        button="Ver más"
        url_button="#entidades-apoyo"
      >
        <p className="font-section">
          La Red de Apoyo Financiero es coordinada por el Banco de los Pobres de la
      ...
      <section className="py-10" id="entidades-apoyo">
        <div className="main-wrapper px-4">
          <SectionTitle color_title="">
      ...
      <Section
        ...
        image_url={`${process.env.NEXT_BASE_PATH}/section3-programas.png`}
        color="bg-color_gray_2"
        side_left
        side_color="left"
      >
      ...
      <Section
        ...
        image_url={`${process.env.NEXT_BASE_PATH}/section4-programas.png`}
        color="bg-white"
        side_color="right"
      >
        <p className="font-section">
        ...
        <p className="font-section">
          ...
          nuestros asesores y pregunta por el programa Comerciantes Informales del Banco de los
          Pobres.
        </p>
        <br />
      </Section>
